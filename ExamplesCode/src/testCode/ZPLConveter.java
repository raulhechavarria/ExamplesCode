...
public class ZPLConveter {
	...
	public static void main(String[] args) throws Exception {
		...
		PDDocument document = PDDocument.load(new File("C:\\Zebra\\l.pdf"));
		PDFRenderer pdfRenderer = new PDFRenderer(document);

		for (int page = 0; page < document.getNumberOfPages(); ++page) {
			BufferedImage orginalImage = pdfRenderer.renderImageWithDPI(page, 200, ImageType.RGB);
			...
			String fileName = "C:\\Zebra\\outfolder\\" + "image-" + page + ".png";
			ImageIOUtil.writeImage(orginalImage, fileName, 300);
		}

		// BufferedImage orginalImage = ImageIO.read(new File("C:\\Zebra\\l.pdf"));
